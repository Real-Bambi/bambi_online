    ...
    return (
        ...
        <>
           <div className="bg-cover bg-center h-[100vh] overflow-hidden" style={{ backgroundImage: `url(${Log})` }}>
            ...
            <form action={postProduct} className="text-white rounded-lg shadow-md border border-solid border-gray-300  py-6 px-10 flex flex-col  h-[95vh] lg:h-[90vh] mt-15 lg:my-10 z-40 lg:w-1/2 w-[90%] mx-auto justify-center " >
