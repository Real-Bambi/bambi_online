...
import EquipVideo from '../../assets/videos/equip.mp4'
    ...
    <div>
      ...
      <div className="p-4">
        <div className=" w-full h-64 md:h-[400px] ">
          ...
          <h1 className=" p-4 absolute top-50 text-white  text-8xl font-bold pt-16 ">Electronics</h1>
        </div>
        ...
        <h1 className="text-3xl font-bold">Commercial Equipment</h1>
